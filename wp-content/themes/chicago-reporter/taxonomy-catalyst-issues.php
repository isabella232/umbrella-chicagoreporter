<?php
/**
 * Template for catalyst-issue term archive pages
 *
 * @package Largo
 * @since 0.4
...
if ( $queried_object->taxonomy == 'catalyst-issues' || $queried_object->taxonomy == 'catalyst-issues' ) {
	...
	<?php
		...
		if ( have_posts() ) {
			...
			while ( have_posts() ) {
				...
				$partial = largo_get_partial_by_post_type( 'catalyst-issues', $post_type, 'catalyst-issues' );
				get_template_part( 'partials/content', $partial );
				do_action( 'largo_loop_after_post_x', $counter, $context = 'catalyst-issues' );
				$counter++;
			}
